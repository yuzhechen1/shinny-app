...
setAccountInfo(name='ndagroup4',
               token='71344CB53AE132886D7EA40EC4303398',
               secret='027gu2QrMZjXP3t5fVSg37IEYGiPldP8K9ZfYZXH')
deployApp("shiny/NDA_Project_Group_4")
